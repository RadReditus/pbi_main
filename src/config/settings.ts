...
export const mssqlLaunchDbLoad = [{"rts_decaux_reklama": true}]; // Список баз для загрузки
...
// =============================================================================
// НАСТРОЙКИ СИНХРОНИЗАЦИИ COMPARE
// =============================================================================

// export const compareSyncTime = "00:00"; // Время синхронизации в 00:00 по GMT (закомментировано)
export const compareSyncTime = "00:00"; // Время синхронизации в 00:00 по GMT
export const compareStartupDelaySeconds = 30; // Задержка перед запуском синхронизации при старте в секундах
